    ...
    namespace GL
    {
        class TextureManager : public RenderSystem::TextureManager
        {
            ...
            public:
                ...
                virtual void loadTexture1D(const InMemoryTextureFile &file, const TextureInitParams &initParams, std::function<void(RenderSystem::Texture *)> onLoadComplete) override;
                ...
                virtual void loadTexture2D(const InMemoryTextureFile &file, const TextureInitParams &initParams, std::function<void(RenderSystem::Texture *)> onLoadComplete) override;
